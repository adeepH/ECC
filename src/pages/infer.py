...
#CSS
    ...
    if st.session_state.username in users and st.session_state.password in users[st.session_state.username]:
        ...
        with st.container():
            ...
            #with col2:
            st.title("Welcome to Velocity Bank's Fraud Detection Portal")
            
            st.markdown('Upload your CSV file and hit the button "DETECT FRAUDULENT ACTIVITY" to uncover any suspicious behavior')
        ...
        if st.button('DETECT FRAUDULENT ACTIVITY'):
